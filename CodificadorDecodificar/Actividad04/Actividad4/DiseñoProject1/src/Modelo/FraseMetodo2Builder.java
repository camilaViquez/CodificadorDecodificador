 ...
 * @author Sebastian
 */
public class FraseMetodo2Builder extends FraseBuilder{
...
//        String resultado = generarFraseMetodo2(alf, cantChars);
...
//        frase.getDto().setFraseEntrada(resultado);
    ...
    public static String generarFraseMetodo2(String alfabeto, int cantChars){
        int numero;
        String resultado = "";
        boolean sirve;
